...
const EliminarEstadoCliente = ({opcionAbierta, cerrarOpcion, estadosCliente}) => {
  ...
  const handleConfirmSubmit = () => {
    const index = estadosCliente.findIndex( estado => estado.get("nombre") === estadoSeleccionado)
    const fecha = new Date();
    estadosCliente[index].set("FechaFinVigencia", fecha);
    estadosCliente[index].save();
    cerrarOpcion("EliminarEstadoCliente")
  }
  ...
  return(
    ...
    >
      ...
      <Modal
        show={opcionAbierta}
        onHide={() => cerrarOpcion("EliminarEstadoCliente")}
        centered
      >
        ...
        {showAlerta
          ...
          : <>
            <Modal.Header className="perfil-usuario glassmorphism">
              <Modal.Title className="w-100 title-modal">ELIMINAR ESTADO CLIENTE</Modal.Title>
            </Modal.Header>
            ...
            <Modal.Body className="perfil-usuario">
              ...
              >
                ...
                <Button
                  ...
                  onClick={() => cerrarOpcion("EliminarEstadoCliente")}
                >Cancelar</Button>
...
export default EliminarEstadoCliente;
